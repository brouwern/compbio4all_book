...
1. Take a broad tour of the wide world of R so see the many faces of R code you may encounter in the wild.
1. Highlight the particular way coding conventions and idioms of R I'll use.
1. Introduce briefly some of the different ways you can get data into R.
...
Examine the series of plots below; what do you thing `type=...` is referring to?
```{r, echo = F}
par(mfrow = c(1,3), mar = c(2,2,2,1))
plot(lynx, type = 4, type = "l")
mtext('col = "l"')
plot(lynx, type = 4, type = "p")
mtext('col = "p"')
plot(lynx, type = 4, type = "b")
mtext('col = "b"')
