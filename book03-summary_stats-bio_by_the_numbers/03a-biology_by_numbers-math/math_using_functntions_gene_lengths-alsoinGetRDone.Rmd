...
* These genes vary in length from `r min(genes_hpc$length, na.rm = T)`  bp to `r max(genes_hpc$length)` 

* mean = `r mean(genes_hpc$length)` bp 

* median = `r median(genes_hpc$length)` bp.
